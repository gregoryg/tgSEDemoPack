...
conn.gsql(''' 
USE GLOBAL
DROP GRAPH HealthCareReferralsGraph

CREATE GRAPH HealthCareReferralsGraph()
USE GRAPH HealthCareReferralsGraph

CREATE SCHEMA_CHANGE JOB HealthCareReferralsGraph_change_job FOR GRAPH HealthCareReferralsGraph {
...
RUN SCHEMA_CHANGE JOB HealthCareReferralsGraph_change_job
DROP JOB HealthCareReferralsGraph_change_job
''', options=[])
